...
export const MovieDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(movieEntity.movieId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.movie.delete.question">
        <Translate contentKey="bmsApp.movie.delete.question" interpolate={{ id: movieEntity.movieId }}>
