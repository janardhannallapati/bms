...
export const updateEntity = createAsyncThunk(
  'movie/update_entity',
  async (entity: IMovie, thunkAPI) => {
    const result = await axios.put<IMovie>(`${apiUrl}/${entity.movieId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IMovie, thunkAPI) => {
    const result = await axios.patch<IMovie>(`${apiUrl}/${entity.movieId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
