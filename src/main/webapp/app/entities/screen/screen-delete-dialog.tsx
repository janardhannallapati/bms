...
export const ScreenDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(screenEntity.screenId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.screen.delete.question">
        <Translate contentKey="bmsApp.screen.delete.question" interpolate={{ id: screenEntity.screenId }}>
