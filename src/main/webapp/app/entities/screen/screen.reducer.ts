...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IScreen, thunkAPI) => {
    const result = await axios.put<IScreen>(`${apiUrl}/${entity.screenId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IScreen, thunkAPI) => {
    const result = await axios.patch<IScreen>(`${apiUrl}/${entity.screenId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
