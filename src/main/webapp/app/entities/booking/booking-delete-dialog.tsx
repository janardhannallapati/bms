...
export const BookingDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(bookingEntity.bookingId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.booking.delete.question">
        <Translate contentKey="bmsApp.booking.delete.question" interpolate={{ id: bookingEntity.bookingId }}>
