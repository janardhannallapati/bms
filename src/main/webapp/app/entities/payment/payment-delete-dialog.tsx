...
export const PaymentDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(paymentEntity.paymentId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.payment.delete.question">
        <Translate contentKey="bmsApp.payment.delete.question" interpolate={{ id: paymentEntity.paymentId }}>
