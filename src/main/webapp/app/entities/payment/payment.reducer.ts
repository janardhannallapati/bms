...
export const getEntities = createAsyncThunk('payment/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IPayment, thunkAPI) => {
    const result = await axios.put<IPayment>(`${apiUrl}/${entity.paymentId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IPayment, thunkAPI) => {
    const result = await axios.patch<IPayment>(`${apiUrl}/${entity.paymentId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
