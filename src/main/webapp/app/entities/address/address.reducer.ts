...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IAddress, thunkAPI) => {
    const result = await axios.put<IAddress>(`${apiUrl}/${entity.addressId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IAddress, thunkAPI) => {
    const result = await axios.patch<IAddress>(`${apiUrl}/${entity.addressId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
