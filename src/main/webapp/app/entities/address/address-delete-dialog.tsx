...
export const AddressDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(addressEntity.addressId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.address.delete.question">
        <Translate contentKey="bmsApp.address.delete.question" interpolate={{ id: addressEntity.addressId }}>
