...
export const CustomerDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(customerEntity.customerId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.customer.delete.question">
        <Translate contentKey="bmsApp.customer.delete.question" interpolate={{ id: customerEntity.customerId }}>
