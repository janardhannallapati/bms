...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_CUSTOMER actions', async () => {
      ...
      await store.dispatch(createEntity({ customerId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
    ...
    it('dispatches UPDATE_CUSTOMER actions', async () => {
      ...
      await store.dispatch(updateEntity({ customerId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMER actions', async () => {
      ...
      await store.dispatch(partialUpdateEntity({ customerId: 123 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
