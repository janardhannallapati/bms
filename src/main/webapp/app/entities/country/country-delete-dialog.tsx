...
export const CountryDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(countryEntity.countryId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.country.delete.question">
        <Translate contentKey="bmsApp.country.delete.question" interpolate={{ id: countryEntity.countryId }}>
