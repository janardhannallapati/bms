...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICountry, thunkAPI) => {
    const result = await axios.put<ICountry>(`${apiUrl}/${entity.countryId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICountry, thunkAPI) => {
    const result = await axios.patch<ICountry>(`${apiUrl}/${entity.countryId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
