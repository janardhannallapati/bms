...
import { getEntity, deleteEntity } from './show.reducer';
...
export const ShowDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(showEntity.showId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.show.delete.question">
        <Translate contentKey="bmsApp.show.delete.question" interpolate={{ id: showEntity.showId }}>
