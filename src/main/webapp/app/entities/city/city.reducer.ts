...
export const updateEntity = createAsyncThunk(
  'city/update_entity',
  async (entity: ICity, thunkAPI) => {
    const result = await axios.put<ICity>(`${apiUrl}/${entity.cityId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICity, thunkAPI) => {
    const result = await axios.patch<ICity>(`${apiUrl}/${entity.cityId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
