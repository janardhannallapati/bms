...
export const CityDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(cityEntity.cityId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.city.delete.question">
        <Translate contentKey="bmsApp.city.delete.question" interpolate={{ id: cityEntity.cityId }}>
