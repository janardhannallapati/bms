...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_LANGUAGE actions', async () => {
      ...
      await store.dispatch(createEntity({ languageId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
    ...
    it('dispatches UPDATE_LANGUAGE actions', async () => {
      ...
      await store.dispatch(updateEntity({ languageId: 456 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
    ...
    it('dispatches PARTIAL_UPDATE_LANGUAGE actions', async () => {
      ...
      await store.dispatch(partialUpdateEntity({ languageId: 123 }));
      expect(store.getActions()[0]).toMatchObject(expectedActions[0]);
      expect(store.getActions()[1]).toMatchObject(expectedActions[1]);
      expect(store.getActions()[2]).toMatchObject(expectedActions[2]);
    });
