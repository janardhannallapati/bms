...
export const LanguageDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(languageEntity.languageId));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bmsApp.language.delete.question">
        <Translate contentKey="bmsApp.language.delete.question" interpolate={{ id: languageEntity.languageId }}>
