...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ILanguage, thunkAPI) => {
    const result = await axios.put<ILanguage>(`${apiUrl}/${entity.languageId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ILanguage, thunkAPI) => {
    const result = await axios.patch<ILanguage>(`${apiUrl}/${entity.languageId}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
