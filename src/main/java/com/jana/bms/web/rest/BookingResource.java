...
import com.jana.bms.service.BookingQueryService;
import com.jana.bms.service.BookingService;
...
/**
 * REST controller for managing {@link com.jana.bms.domain.Booking}.
 */
@RestController
@RequestMapping("/api")
public class BookingResource {
    ...
    public ResponseEntity<BookingDTO> createBooking(@Valid @RequestBody BookingDTO bookingDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getBookingId().toString()))
            .body(result);
    }
     ...
     *
     * @param bookingId the id of the bookingDTO to save.
    ...
    public ResponseEntity<BookingDTO> updateBooking(
        ...
        log.debug("REST request to update Booking : {}, {}", bookingId, bookingDTO);
        if (bookingDTO.getBookingId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(bookingId, bookingDTO.getBookingId())) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, bookingDTO.getBookingId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BookingDTO> partialUpdateBooking(
        ...
        log.debug("REST request to partial update Booking partially : {}, {}", bookingId, bookingDTO);
        if (bookingDTO.getBookingId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(bookingId, bookingDTO.getBookingId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, bookingDTO.getBookingId().toString())
        );
    }
    ...
    public ResponseEntity<List<BookingDTO>> getAllBookings(
        ...
        log.debug("REST request to get Bookings by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countBookings(BookingCriteria criteria) {
        log.debug("REST request to count Bookings by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
