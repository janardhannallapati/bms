...
import com.jana.bms.service.CountryQueryService;
import com.jana.bms.service.CountryService;
...
/**
 * REST controller for managing {@link com.jana.bms.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<List<CountryDTO>> getAllCountries(
        ...
        log.debug("REST request to get Countries by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countCountries(CountryCriteria criteria) {
        log.debug("REST request to count Countries by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
