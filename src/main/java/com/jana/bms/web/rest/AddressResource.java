...
import com.jana.bms.service.AddressQueryService;
import com.jana.bms.service.AddressService;
...
/**
 * REST controller for managing {@link com.jana.bms.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    public ResponseEntity<AddressDTO> createAddress(@Valid @RequestBody AddressDTO addressDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getAddressId().toString()))
            .body(result);
    }
     ...
     *
     * @param addressId the id of the addressDTO to save.
    ...
    public ResponseEntity<AddressDTO> updateAddress(
        @PathVariable(value = "addressId", required = false) final Long addressId,
        @Valid @RequestBody AddressDTO addressDTO
    ) throws URISyntaxException {
        log.debug("REST request to update Address : {}, {}", addressId, addressDTO);
        if (addressDTO.getAddressId() == null) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, addressDTO.getAddressId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AddressDTO> partialUpdateAddress(
        ...
        log.debug("REST request to partial update Address partially : {}, {}", addressId, addressDTO);
        if (addressDTO.getAddressId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(addressId, addressDTO.getAddressId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, addressDTO.getAddressId().toString())
        );
    }
    ...
    public ResponseEntity<List<AddressDTO>> getAllAddresses(
        ...
        log.debug("REST request to get Addresses by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countAddresses(AddressCriteria criteria) {
        log.debug("REST request to count Addresses by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
