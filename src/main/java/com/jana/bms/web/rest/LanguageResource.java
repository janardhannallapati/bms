...
import com.jana.bms.service.LanguageQueryService;
import com.jana.bms.service.LanguageService;
...
/**
 * REST controller for managing {@link com.jana.bms.domain.Language}.
 */
@RestController
@RequestMapping("/api")
public class LanguageResource {
    ...
    public ResponseEntity<List<LanguageDTO>> getAllLanguages(
        ...
        log.debug("REST request to get Languages by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countLanguages(LanguageCriteria criteria) {
        log.debug("REST request to count Languages by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
